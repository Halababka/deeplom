//LOADER (ожидание загрузки страницы)
window.addEventListener('load', () => {
	const loader = document.getElementById('loader');
	loader.style.display = 'none';
});

//Вертикальная прокрутка после загрузки страницы
window.addEventListener('load', function () {
	setTimeout(function () {
		window.scrollTo(0, window.scrollY - 100); // Прокрутить на 100 пикселей вниз
	}, 10); // Задержка в 1 секунду
});

//Подключаю прайс-лист
// import "../files/price.js";
//Подключаю липкий navbar
import "../files/sticky.js";
//Подключаю переход на нужную страницу и блок
// import "../files/redirect.js";
