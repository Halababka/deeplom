        ...
        const doctors = await Promise.all([
            prisma.doctor.create({
                data: {
                    ...
                    educationPlaces: JSON.stringify(['МГМСУ им. А.И. Евдокимова', 'РНИМУ им. Н.И. Пирогова']),
                    courses: JSON.stringify(['Курсы повышения квалификации по имплантологии', 'Курсы по эстетической реставрации']),
            ...
            prisma.doctor.create({
                data: {
                    ...
                    educationPlaces: JSON.stringify(['СПбГМУ им. И.П. Павлова', 'МГМСУ им. А.И. Евдокимова']),
                    courses: JSON.stringify(['Курсы по эстетической реставрации', 'Курсы по ортопедической стоматологии']),
            ...
            prisma.doctor.create({
                data: {
                    ...
                    educationPlaces: JSON.stringify(['МГМСУ им. А.И. Евдокимова', 'СПбГМУ им. И.П. Павлова']),
                    courses: JSON.stringify(['Курсы по хирургической стоматологии', 'Курсы по имплантологии']),
